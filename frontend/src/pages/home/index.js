            ...
            <Grid container spacing={2}>
                <Grid item xs={12} md={6}>
                    <Paper className={classes.paper}>
                        <Typography variant="h4" paragraph="true">Make Your own customized Barbra Streisand song!</Typography>
                ...
                <Grid item xs={12} md={6}>
                    <Paper className={classes.paper} >
                        <Typography variant="h4" paragraph="true">Hit List</Typography>
                        <HitList/>
                    </Paper>
                </Grid>
            </Grid>
